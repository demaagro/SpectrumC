...
#[derive(Debug)]
pub struct SpectrumCSSProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpectrumCSSProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpectrumCSS processing");
    
    let mut processor = SpectrumCSSProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpectrumCSSProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpectrumCSSProcessor::new(false);
